/*
Importing wots-js module from:
https://github.com/NickP005/WOTS-JS/blob/main/wots.mjs
*/
import {sha256, wots_public_key_gen, wots_sign, wots_publickey_from_sig, from_int_to_byte_array, byte_copy} from 'wots.mjs';
...
//PUSH THE TRANSACTION TO
// - A node, with sockets, so push the bytes
// - The mochimo api, with HTTP POST request, so with base64 encoded TX
//console.log("curl -d  '{\"transaction\":\"" + _arrayBufferToBase64(transaction) + "\",\"recipients\":\"1\"}' -H 'Content-Type: application/json' -X POST http://api.mochimo.org:8888/push");
//console.log(_arrayBufferToBase64(transaction));
